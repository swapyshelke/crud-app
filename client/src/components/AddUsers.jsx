...
const AddUsers = () => {
  ...
  return (
    <form className="bg-slate-800 text-white h-screen flex items-center justify-center">
      <div class="relative flex flex-col text-white bg-transparent shadow-none rounded-xl bg-clip-border">
        <h1 class="text-center mt-12 block font-sans text-2xl antialiased font-semibold leading-snug tracking-normal">
          Add Users
        </h1>
        <form class="max-w-screen-lg mt-8 mb-2 w-80 sm:w-96">
          ...
          <div class="flex flex-col gap-6 mb-1">
            ...
            <h6 class="block text-center -mb-3 font-sans text-base antialiased font-semibold leading-relaxed tracking-normal text-white">
              Enter Phone
            </h6>
            <div class="relative h-11 w-full min-w-[200px]">
              <input
